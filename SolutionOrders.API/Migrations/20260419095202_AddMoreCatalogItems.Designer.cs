...
namespace SolutionOrders.API.Migrations
{
    ...
    [Migration("20260419095202_AddMoreCatalogItems")]
    partial class AddMoreCatalogItems
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SolutionOrders.API.Models.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IdItem = 3,
                            Code = "BUD-FAR-10",
                            Description = "Matowa farba do ścian i sufitów",
                            IdBrand = 1,
                            IdCategory = 1,
                            IdSupplier = 1,
                            ...
                            IdWarehouse = 1,
                            IsActive = true,
                            Name = "Farba biała lateksowa 10 l",
                            Price = 119m,
                            Quantity = 42m
                        },
                        new
                        {
                            IdItem = 4,
                            Code = "BUD-PAN-DAB",
                            Description = "Panel laminowany AC4 do salonu i korytarza",
                            IdBrand = 1,
                            IdCategory = 1,
                            IdSupplier = 1,
                            IdUnitOfMeasurement = 1,
                            IdWarehouse = 1,
                            IsActive = true,
                            Name = "Panel podłogowy dąb naturalny",
                            Price = 46m,
                            Quantity = 260m
                        },
                        new
                        {
                            IdItem = 5,
                            Code = "BUD-DRZ-80",
                            Description = "Proste drzwi pokojowe z ościeżnicą",
                            IdBrand = 1,
                            IdCategory = 1,
                            IdSupplier = 1,
                            IdUnitOfMeasurement = 1,
                            IdWarehouse = 1,
                            IsActive = true,
                            Name = "Drzwi wewnętrzne białe 80 cm",
                            Price = 399m,
                            Quantity = 14m
                        },
                        new
                        {
                            IdItem = 6,
                            Code = "BUD-GRE-6060",
                            Description = "Gres do łazienki, kuchni i przedpokoju",
                            IdBrand = 1,
                            IdCategory = 1,
                            IdSupplier = 1,
                            IdUnitOfMeasurement = 1,
                            IdWarehouse = 1,
                            IsActive = true,
                            Name = "Płytki gresowe szare 60x60",
                            Price = 79m,
                            Quantity = 180m
                        },
                        new
                        {
                            IdItem = 7,
                            Code = "BUD-KLE-25",
                            Description = "Klej do gresu i glazury, do wnętrz i na zewnątrz",
                            IdBrand = 1,
                            IdCategory = 1,
                            IdSupplier = 1,
                            IdUnitOfMeasurement = 2,
                            IdWarehouse = 1,
                            IsActive = true,
                            Name = "Klej do płytek elastyczny 25 kg",
                            Price = 54m,
                            Quantity = 95m
                        },
                        new
                        {
                            IdItem = 8,
                            Code = "NAR-SDS-PLUS",
                            Description = "Młotowiertarka do cięższych prac remontowych",
                            IdBrand = 2,
                            IdCategory = 2,
                            IdSupplier = 2,
                            IdUnitOfMeasurement = 1,
                        ...
                        new
                        {
                            IdItem = 9,
                            Code = "NAR-WKR-12",
                            Description = "Wkrętaki płaskie i krzyżakowe do warsztatu",
                            IdBrand = 2,
                            IdCategory = 2,
                            IdSupplier = 2,
                            IdUnitOfMeasurement = 1,
                            IdWarehouse = 2,
                            IsActive = true,
                            Name = "Zestaw wkrętaków 12 elementów",
                            Price = 69m,
                            Quantity = 35m
                        },
                        new
                        {
                            IdItem = 10,
                            Code = "NAR-TAS-5M",
                            Description = "Miarka zwijana z blokadą do pomiarów budowlanych",
                            IdBrand = 2,
                            IdCategory = 2,
                            IdSupplier = 2,
                            IdUnitOfMeasurement = 1,
